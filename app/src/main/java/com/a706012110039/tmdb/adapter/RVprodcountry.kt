...
import com.a706012110039.tmdb.model.ProductionCountry

class RVprodcountry(private val dataSet: List<ProductionCountry>) :
        RecyclerView.Adapter<RVprodcountry.ViewHolder>() {

    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val binding = CardGenreBinding.bind(itemView)

        fun setdata(data: ProductionCountry){
